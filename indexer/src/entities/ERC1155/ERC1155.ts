...
export class GrantMinerRoleCall extends ethereum.Call {
  get inputs(): GrantMinerRoleCall__Inputs {
    return new GrantMinerRoleCall__Inputs(this);
  }

  get outputs(): GrantMinerRoleCall__Outputs {
    return new GrantMinerRoleCall__Outputs(this);
  }
}

export class GrantMinerRoleCall__Inputs {
  _call: GrantMinerRoleCall;

  constructor(call: GrantMinerRoleCall) {
    this._call = call;
  }
...
export class GrantMinerRoleCall__Outputs {
  _call: GrantMinerRoleCall;
...
export class GrantPauserRoleCall extends ethereum.Call {
  get inputs(): GrantPauserRoleCall__Inputs {
    return new GrantPauserRoleCall__Inputs(this);
  }

  get outputs(): GrantPauserRoleCall__Outputs {
    return new GrantPauserRoleCall__Outputs(this);
  }
}

export class GrantPauserRoleCall__Inputs {
  _call: GrantPauserRoleCall;

  constructor(call: GrantPauserRoleCall) {
    this._call = call;
  }
...
export class GrantPauserRoleCall__Outputs {
  _call: GrantPauserRoleCall;
